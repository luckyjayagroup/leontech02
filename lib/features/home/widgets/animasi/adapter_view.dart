...
class AdapterView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget panel = Container(
      color: const Color.fromARGB(255, 201, 204, 214),
    ...
    Widget list = Stack(
      children: [
        // background color:
        Container(color: const Color.fromARGB(255, 3, 218, 128)),
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(
                ...
                colors: [Color.fromARGB(221, 236, 240, 241), Color.fromARGB(181, 128, 221, 255)]),
          ),
        )
            .animate(
