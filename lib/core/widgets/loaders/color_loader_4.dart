...
class ColorLoader4 extends StatefulWidget {
  ...
  const ColorLoader4({super.key, this.dotOneColor = Colors.redAccent, this.dotTwoColor = Colors.green, this.dotThreeColor = Colors.blueAccent, this.duration = const Duration(milliseconds: 1000), this.dotType = DotType.circle, this.dotIcon = const Icon(Icons.blur_on)});

  @override
  State<ColorLoader4> createState() => _ColorLoader4State();
}
